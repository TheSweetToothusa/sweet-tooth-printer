...
app.get('/dashboard/gift-card-new', async (req, res) => {
  ...
  var toolbarHTML = '<div class=\"fmt-section\"><span class=\"fmt-label\">Message Font</span><select id=\"fmtFont\" class=\"fmt-select\" onchange=\"updatePreview()\"><option value=\"Montserrat\" style=\"font-family:Montserrat\">Montserrat</option><option value=\"Playfair Display\" style=\"font-family:Playfair Display\">Playfair Display</option><option value=\"Dancing Script\" style=\"font-family:Dancing Script\">Dancing Script</option><option value=\"Lato\" style=\"font-family:Lato\">Lato</option><option value=\"Cormorant Garamond\" style=\"font-family:Cormorant Garamond\">Cormorant Garamond</option><option value=\"Great Vibes\" style=\"font-family:Great Vibes\">Great Vibes</option><option value=\"Libre Baskerville\" style=\"font-family:Libre Baskerville\">Libre Baskerville</option><option value=\"Raleway\" style=\"font-family:Raleway\">Raleway</option><option value=\"Pacifico\" style=\"font-family:Pacifico\">Pacifico</option><option value=\"EB Garamond\" style=\"font-family:EB Garamond\">EB Garamond</option></select></div><div class=\"fmt-section\"><span class=\"fmt-label\">Font Size</span><div class=\"fmt-size-row\"><input type=\"range\" id=\"fmtSize\" min=\"7\" max=\"50\" value=\"10\" step=\"0.5\" oninput=\"updatePreview()\"><span class=\"fmt-size-val\" id=\"fmtSizeVal\">10pt</span></div></div><div class=\"fmt-section\"><span class=\"fmt-label\">Style</span><div class=\"fmt-toggle-group\"><button class=\"fmt-toggle active\" id=\"toggleBold\" data-fmt=\"bold\" onclick=\"toggleFmt(this.dataset.fmt)\"><b>B</b></button><button class=\"fmt-toggle\" id=\"toggleItalic\" data-fmt=\"italic\" onclick=\"toggleFmt(this.dataset.fmt)\"><i>I</i></button></div></div><div class=\"fmt-section\"><span class=\"fmt-label\">Alignment</span><div class=\"fmt-toggle-group\"><button class=\"fmt-toggle\" id=\"toggleAlignLeft\" onclick=\"setAlign(\'left\')\">L</button><button class=\"fmt-toggle active\" id=\"toggleAlignCenter\" onclick=\"setAlign(\'center\')\">C</button><button class=\"fmt-toggle\" id=\"toggleAlignRight\" onclick=\"setAlign(\'right\')\">R</button></div></div><div class=\"fmt-section\"><span class=\"fmt-label\">Line Spacing</span><div class=\"fmt-size-row\"><input type=\"range\" id=\"lineSpacing\" min=\"1\" max=\"2.5\" value=\"1.5\" step=\"0.1\" oninput=\"updatePreview()\"><span class=\"fmt-size-val\" id=\"lineSpacingVal\">1.5</span></div></div><div class=\"fmt-section\"><span class=\"fmt-label\">Name Size</span><div class=\"fmt-size-row\"><input type=\"range\" id=\"nameSize\" min=\"8\" max=\"40\" value=\"11.9\" step=\"0.5\" oninput=\"updatePreview()\"><span class=\"fmt-size-val\" id=\"nameSizeVal\">11.9pt</span></div></div><div class=\"fmt-section\"><span class=\"fmt-label\">Address Size</span><div class=\"fmt-size-row\"><input type=\"range\" id=\"addrSize\" min=\"6\" max=\"40\" value=\"9.35\" step=\"0.5\" oninput=\"updatePreview()\"><span class=\"fmt-size-val\" id=\"addrSizeVal\">9.35pt</span></div></div><hr class=\"fmt-divider\">';
  ...
  html += 'function toggleFmt(t){if(t==="bold"){fmtBold=!fmtBold;document.getElementById("toggleBold").className="fmt-toggle"+(fmtBold?" active":"")}else{fmtItalic=!fmtItalic;document.getElementById("toggleItalic").className="fmt-toggle"+(fmtItalic?" active":"")}updatePreview()}';
  html += 'function setAlign(a){fmtAlign=a;document.getElementById("toggleAlignLeft").className="fmt-toggle"+(a==="left"?" active":"");document.getElementById("toggleAlignCenter").className="fmt-toggle"+(a==="center"?" active":"");document.getElementById("toggleAlignRight").className="fmt-toggle"+(a==="right"?" active":"");updatePreview()}';
  html += 'function getFmtFont(){return document.getElementById("fmtFont").value}';
  html += 'function getFmtSize(){var v=parseFloat(document.getElementById("fmtSize").value);document.getElementById("fmtSizeVal").textContent=v+"pt";return v+"pt"}';
  html += 'function updatePreview(){';
  ...
  html += 'var availPx=612-(4.30/8.5*612)-12;var contentH=document.getElementById("msgSection").offsetHeight;var fsv=document.getElementById("fmtSizeVal");var fszNum=parseFloat(document.getElementById("fmtSize").value);if(contentH>availPx){fsv.style.color="red";fsv.textContent=fszNum+"pt ⚠ will cut off"}else{fsv.style.color="#000";fsv.textContent=fszNum+"pt"}';
  html += '}';
  html += 'function printToPrinter(){';
  html += 'var fs=getFmtSize();var font=getFmtFont();';
  html += 'var nameSz=parseFloat(document.getElementById("nameSize").value);var addrSz=parseFloat(document.getElementById("addrSize").value);var lineSp=parseFloat(document.getElementById("lineSpacing").value);';
