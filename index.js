...
app.get('/dashboard/gift-card-new', async (req, res) => {
  ...
  html += '<div id="prevOrderCode" style="position:absolute;bottom:1.5%;left:0;right:0;text-align:center;font-family:Arial,sans-serif;font-size:6pt;color:#bbb"></div>';
  html += '</div></div>';
