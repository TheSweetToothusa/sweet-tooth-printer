...
app.get('/dashboard/print-custom/:orderId', async (req, res) => {
  try {
    ...
    html += '<div style="position:absolute;bottom:4.7%;right:7%;font-family:Arial,sans-serif;font-size:6pt;color:#bbb">'+orderData.orderNumber+'</div>';
    html += '</div></div>';
    html += '<script>';
...
app.get('/dashboard/gift-card-new', async (req, res) => {
  ...
  html += '<div id="prevOrderCode" style="position:absolute;bottom:4.7%;right:7%;font-family:Arial,sans-serif;font-size:6pt;color:#bbb"></div>';
  html += '</div></div>';
